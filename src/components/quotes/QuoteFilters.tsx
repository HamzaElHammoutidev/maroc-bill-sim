      ...
      <div className="flex flex-1 gap-2">
        ...
        <div className="flex-1">
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            <SelectTrigger className="w-full">
              <SelectValue placeholder={t('quotes.statusFilter')} />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="all">{t('quotes.allStatus')}</SelectItem>
              <SelectItem value="draft">{t('quotes.status.draft')}</SelectItem>
              <SelectItem value="pending_validation">{t('quotes.status.pending_validation')}</SelectItem>
              <SelectItem value="awaiting_acceptance">{t('quotes.status.awaiting_acceptance')}</SelectItem>
        ...
        <div className="flex-1">
          <Select value={clientFilter} onValueChange={setClientFilter}>
            <SelectTrigger className="w-full">
              <SelectValue placeholder={t('quotes.clientFilter')} />
            </SelectTrigger>
            <SelectContent>
